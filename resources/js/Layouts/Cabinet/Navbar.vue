...
<template>
    <nav
        class="lg:ml-4 bg-slate-900 border-slate-700 text-slate-300 lg:bg-white dark:bg-slate-900 border-b lg:border-slate-100 dark:border-slate-800 lg:text-slate-500 dark:text-slate-300"
    >
                        ...
                        <div class="relative">
                            <Dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <DropdownLink :href="route('cabinet.profile.edit')">
                                        {{ lang().label.profile }}
                                    </DropdownLink>
                                    <DropdownLink
