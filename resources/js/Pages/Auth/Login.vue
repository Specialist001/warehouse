...
<template>
    <GuestLayout>
        ...
        <template #illustration>
            <AuthenticationIllustration type="login" class="w-72 h-auto" />
        </template>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-between mt-4 ">
                <Link
                    ...
                    class="float-left underline text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary dark:focus:ring-offset-slate-800"
                >
