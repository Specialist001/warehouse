...
defineProps(["modelValue", "dataSet", "prompt", "promptDisabled", "multiple"]);
...
<template>
    <select
        ...
        :multiple="multiple"
    >
        <option v-if="promptDisabled" value="" disabled>{{ promptDisabled }}</option>
        <option v-else-if="prompt" value="">{{ prompt }}</option>
        <option
